    ...
    init() {
        ...
        for _ in 0..<maxNumberOfUsers{
            ...
            let user = UserModel(username: username,
                                 fullname: fullname,
                                 bio: "To be left from someone you need will make you regret that you knew him from the start, not because he was a bad person but because he made you feel happiness to the point of pain",
                                 image: URL(string:
...
To be left from someone you need will make you regret that you knew him from the start, not because he was a bad person but because he made you feel happiness to the point of pain
